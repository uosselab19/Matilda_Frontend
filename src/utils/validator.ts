...
export function notMinLength(value: any, minLength = 8, customMessage?: string) {
...
export function notMaxLength(value: any, maxLength = 8, customMessage?: string) {
...
export function notMin(value: any, min = 8, customMessage?: string) {
...
export function notMax(value: any, max = 8, customMessage?: string) {
