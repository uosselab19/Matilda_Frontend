...
export const RegisterNFT = () => {
	...
	itemList.forEach((info, index) => {
		optionList.push(<option key={index} value={index}>{info.title}</option>);
	})
					...
					<form id="signupForm" className="needs-validation" noValidate>
						<div className="row g-3">
							...
							<div className="col-12">
								...
								<input className="form-control border-dark" id="id" placeholder={itemList[itemIndex].title} type="id" required />
							...
							<div className="col-12">
								...
								<textarea className="form-control border-dark " id="text" rows={7} style={{resize: "none"}}/>
							</div>
