...
export const Mypage = () => {
  ...
  const MypageContent = (seletedNum: number) => {
    switch (seletedNum) {
      ...
      case 1: return <MypageWallet />;
      case 2: return <MypageOption />;
        ...
        <div className="row my-3">
          ...
          <div className="col-lg-8">
            <div className="row my-3">
              <div className="col-lg-4">
                <button
                  className={`btn btn-outline-light px-2 ${(seletedTap == 0) ? "text-dark fw-bold" : "text-secondary"} text-decoration-none fs-5`}
              ...
              <div className="col-lg-4">
                <button
                  className={`btn btn-outline-light px-2 ${(seletedTap == 1) ? "text-dark fw-bold" : "text-secondary"} text-decoration-none fs-5`}
