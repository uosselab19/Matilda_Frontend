...
export const Signup = () => {
  ...
  const handleInputNickname = (e: ChangeEvent<HTMLInputElement>) => { setInputNickname(e.target.value); };
        ...
        <form id="signupForm" className="needs-validation" noValidate>
          <div className="row g-3">
            ...
            <div className="col-12">
              ...
              <input className="form-control border-dark" id="id"
                type="id" required
            ...
            <div className="col-12">
              ...
              <div className="input-group has-validation">
                <input className="form-control border-dark" id="nickname" placeholder=""
                  type="text" required
                  value={inputNickname} onChange={handleInputNickname} />
                <div className="invalid-feedback">
            ...
            <div className="col-12">
              ...
              <input className="form-control border-dark" id="email" placeholder="mindul@example.com"
                type="email" required
          ...
          <div className="col-12 my-4">
            <div className="form-check">
              ...
              <label className="form-check-label" htmlFor="save-info">약관 동의를 위한 체크버튼</label>
            </div>
          </div>

          <button className="w-100 btn btn-primary btn-lg bg-dark" type="submit" onClick={submit}>Continue to Sign-up</button>
        </form>
      </div>
    </main>
  );
