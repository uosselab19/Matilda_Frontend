      ...
      <div className="row my-5">
        ...
        <div className="col-lg-7">
          <article className="blog-post">
            ...
            <div className="row my-5">
              <div className="col-3"><h3 className="blog-post-title">Price</h3></div>
              <div className="col-9"><h3>{NFT_info.price}\</h3></div>
            </div>
                ...
                <div className="modal-dialog">
                  <div className="modal-content">
                    <div className="modal-header">
                      <h1 className="modal-title" id="staticBackdropLabel">{NFT_info.title}</h1>
